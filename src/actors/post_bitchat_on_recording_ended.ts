...
export const queue = 'post_bitchat_on_recording_ended'

export const routingkey = 'jaas.8x8.vc.webhook'

import { bsv } from 'scrypt-ts'
import { listUnspent, broadcastTransaction } from '../whatsonchain'
...
async function notifyBitchat(json: any) {
  ...
  console.log("RECORDING_ENDED", json)
    ...
    const script: bsv.Script = buildMessageScript({
      content: 'The Recording In This Meeting Room Has Ended',
      channel
    })
